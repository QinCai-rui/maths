...
export function previewQuestionSet(set: Set) {
  ...
  return openPrintDocument(
    ...
    `<main>${slips}</main>`,
    `@page { size: A4 portrait; margin: 0; } * { box-sizing: border-box; } body { margin: 0; color: #111; background: #fff; font-family: Arial, sans-serif; } .slip { width: 210mm; height: 50mm; padding: 5mm 8mm 4mm 18mm; border-bottom: 1px dashed #777; position: relative; overflow: hidden; break-inside: avoid; } .slip::before { content: ""; position: absolute; inset: 0 auto 0 10mm; border-left: 1px solid #aaa; } .slip-content { height: 33mm; overflow: hidden; line-height: 1.2; } .slip-content img { position: static !important; float: none !important; clear: both; max-width: 100%; max-height: ${options.imageHeight}mm; object-fit: contain; display: block; margin: 1.5mm 0; } .number { font-size: 8pt; font-weight: bold; text-transform: uppercase; letter-spacing: .08em; margin-bottom: 2mm; } .cover h1 { margin: 0 0 2mm; font-size: 18pt; } .cover .slip-content { height: 40mm; } p { margin: 0 0 2mm; } blockquote { margin: 2mm 0; padding-left: 3mm; border-left: 2px solid #777; }`,
    true
  );
}
